...
> **Token matching default is AND.** Multi-keyword queries like `"decided committed resolved"`
> require ALL tokens present in the same entry — this often returns 0 hits.
> Add `or:` to use OR matching: any token qualifies.
> Use `or:` whenever searching for any of several keywords.
