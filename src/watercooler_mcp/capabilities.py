...
def resolve_search_capability(mode: str, query: str = "", semantic: bool = False) -> CapabilityId:
...
def tool_capability(tool_name: str, arguments: dict[str, Any] | None = None) -> CapabilityId:
