...
def _env_to_config_key(env_var: str) -> tuple[list[str], str]:
    ...
    ENV_MAPPING: Dict[str, tuple[list[str], str]] = {
        ...
        "WATERCOOLER_MEMORY_QUEUE_MAX_WORKERS": (["memory"], "queue_max_workers"),
        # Memory LLM
...
def _apply_env_overlay(config_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    env_vars = [
        ...
        "WATERCOOLER_MEMORY_QUEUE_MAX_WORKERS",
        "LLM_API_KEY",
        "LLM_API_BASE",
        "LLM_MODEL",
        "EMBEDDING_API_KEY",
